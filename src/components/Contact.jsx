                ...
                <Row>
                    <Col lg={4}>
                        ...
                        <div className="contact-text">
                            <p>Pranay Patil <br />  At.Washim Dis.Washim,Maharashtra <br /> <strong style={{fontWeight:"600"}}>9923757222</strong>
                                <br />
                                <strong style={{fontWeight:"600"}}>patilpranay102001@gmail.com</strong>
                            </p>
                        </div>
